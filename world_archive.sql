...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Ápr 11. 10:17
...
--
-- Tábla szerkezet ehhez a táblához `countrylanguage`
--
...
--
-- A tábla adatainak kiíratása `countrylanguage`
--
...
--
-- A tábla indexei `countrylanguage`
--
...
--
-- Megkötések a táblához `countrylanguage`
--
ALTER TABLE `countrylanguage`
